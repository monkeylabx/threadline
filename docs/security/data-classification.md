...
V33产品提案说明：私人Prompt、草稿、上下文和工具输出仍为C3，不因引用频道或生成Artifact而改变受众。
共享Task的状态摘要规则不能直接套用到私人工作。私人历史的持久化、Retention与恢复仍需
[ADR-0005](../adr/0005-private-work-publication-boundary.md)评审；“仅你可见”不代表模型Endpoint不接收批准的输入，
也不构成对受控设备或合法导出的绝对隐私保证。
